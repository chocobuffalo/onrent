...
export interface CreateMachineryRequest 
  extends BasicMachineryData, TechnicalSpecs, GeolocationData {   
  external_id?: string;   
  image?: File; 
}

export interface UpdateMachineryRequest 
  extends Partial<BasicMachineryData>, Partial<TechnicalSpecs>, GeolocationData {   
  external_id?: string;   
  image?: File; 
}
...
/**
 * Columnas genéricas para cualquier tipo de dato
 */
