...
export default function SelectInput({options,name,register,label,placeHolder,errors}:{errors:any,name:string,options: SelectInterface[],register:any,value?:SelectInterface,label:string, placeHolder?:string }){
